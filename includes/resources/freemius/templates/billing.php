            ...
            <div id="fs_billing">
                <div class="has-sidebar has-right-sidebar">
                    <div class="has-sidebar-content">
                        <div class="postbox">
                            <h3><span class="dashicons dashicons-businessman"></span> <?php _efs( 'billing', $slug ) ?>
                            </h3>
                            <table id="fs_billing_address"<?php if ( $has_billing ) {
								echo ' class="fs-read-mode"';
							} ?>>
                                <tr>
                                    <td><label><span><?php _efs( 'business-name', $slug ) ?>:</span> <input
                                                    id="business_name" value="<?php echo $billing->business_name ?>"
                                                    placeholder="<?php _efs( 'business-name', $slug ) ?>"></label></td>
                                    <td><label><span><?php _efs( 'tax-vat-id', $slug ) ?>:</span> <input id="tax_id"
                                                                                                         value="<?php echo $billing->tax_id ?>"
                                                                                                         placeholder="<?php _efs( 'tax-vat-id', $slug ) ?>"></label>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label><span><?php printf( __fs( 'address-line-n', $slug ), 1 ) ?>:</span>
                                            <input id="address_street" value="<?php echo $billing->address_street ?>"
                                                   placeholder="<?php printf( __fs( 'address-line-n', $slug ), 1 ) ?>"></label>
                                    </td>
                                    <td><label><span><?php printf( __fs( 'address-line-n', $slug ), 2 ) ?>:</span>
                                            <input id="address_apt" value="<?php echo $billing->address_apt ?>"
                                                   placeholder="<?php printf( __fs( 'address-line-n', $slug ), 2 ) ?>"></label>
                                    </td>
                                </tr>
                                <tr>
                                    <td><label><span><?php _efs( 'city', $slug ) ?> / <?php _efs( 'town', $slug ) ?>
                                                :</span> <input id="address_city"
                                                                value="<?php echo $billing->address_city ?>"
                                                                placeholder="<?php _efs( 'city', $slug ) ?> / <?php _efs( 'town', $slug ) ?>"></label>
                                    </td>
                                    <td><label><span><?php _efs( 'zip-postal-code', $slug ) ?>:</span> <input
                                                    id="address_zip" value="<?php echo $billing->address_zip ?>"
                                                    placeholder="<?php _efs( 'zip-postal-code', $slug ) ?>"></label>
                                    </td>
                                </tr>
                                <tr>
									<?php $countries = array(
                                    ...
                                    <td><label><span><?php _efs( 'country', $slug ) ?>:</span> <select
                                    ...
                                    <td><label><span><?php _efs( 'state', $slug ) ?>
                                                / <?php _efs( 'province', $slug ) ?>:</span>
                                            <input id="address_state" value="<?php echo $billing->address_state ?>"
                                                   placeholder="<?php _efs( 'state', $slug ) ?> / <?php _efs( 'province', $slug ) ?>"></label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                        ...
                        <div class="postbox">
                            <h3><span class="dashicons dashicons-paperclip"></span> <?php _efs( 'payments', $slug ) ?>
                            </h3>
