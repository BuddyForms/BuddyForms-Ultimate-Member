            ...
            <div>
				...
				<?php printf( __fs( 'x-ago', $api->slug ), human_time_diff( strtotime( $api->last_updated ) ) ); ?>
					...
					if ( ! empty( $api->tested ) ) {
						?>
                        <li>
                            <strong><?php _efs( 'compatible-up-to:', $api->slug ); ?></strong> <?php echo $api->tested; ?>
                        </li>
						<?php
					}
					...
					if ( ! empty( $api->slug ) && empty( $api->external ) ) {
						?>
                        <li><a target="_blank"
                               href="https://wordpress.org/plugins/<?php echo $api->slug; ?>/"><?php _efs( 'wp-org-plugin-page', $api->slug ); ?>
                                &#187;</a>
                        </li>
						<?php
					}
					if ( ! empty( $api->homepage ) ) {
						?>
                        <li><a target="_blank"
                               href="<?php echo esc_url( $api->homepage ); ?>"><?php _efs( 'plugin-homepage', $api->slug ); ?>
                                &#187;</a>
                        </li>
						<?php
					}
					if ( ! empty( $api->donate_link ) && empty( $api->contributors ) ) {
						?>
                        <li><a target="_blank"
                               href="<?php echo esc_url( $api->donate_link ); ?>"><?php _efs( 'donate-to-plugin', $api->slug ); ?>
                                &#187;</a>
                        </li>
					<?php } ?>
                </ul>
